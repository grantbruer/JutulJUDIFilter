...
#SBATCH --job-name=fig-gt
#SBATCH -o "$job_dir"/slurm/slurm-out-fig-gt-%j.txt
#SBATCH --time=2:00:00
#SBATCH --gres=gpu:0
#SBATCH -N 1
#SBATCH --ntasks=1
...
/usr/bin/time --verbose srun julia scripts/ground_truth_figures.jl "$params_file" "$job_dir"
EOT
