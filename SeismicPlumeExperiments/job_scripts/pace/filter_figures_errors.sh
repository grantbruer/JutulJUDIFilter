...
#SBATCH --job-name=fig-errors
#SBATCH -o "$job_dir"/slurm/slurm-out-fig-errors-%j.txt
#SBATCH --time=1:00:00
#SBATCH --gres=gpu:0
#SBATCH -N 1
#SBATCH --ntasks=1
...
/usr/bin/time --verbose srun julia scripts/filter_figures_errors.jl "$params_file" "$job_dir"
EOT
