...
#SBATCH --job-name=fig-params
#SBATCH -o "$job_dir"/slurm/slurm-out-fig-params-%j.txt
#SBATCH --time=4:00:00
#SBATCH -p cpu
#SBATCH --gres=gpu:0
#SBATCH --ntasks=1
...
module load Julia/1.9/3 cudnn nvhpc

export OMP_NUM_TREADS=1
export JULIA_NUM_THREADS=1

/usr/bin/time --verbose srun julia --project=. scripts/filter_figures_params.jl "$params_file" "$job_dir"
EOT
